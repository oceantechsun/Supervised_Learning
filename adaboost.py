...
dataset = pd.read_csv(url, header = None, names= names, sep=';').iloc[1:,:]
...
plt.legend(loc="best")
plt.savefig("test_size_vs_accuracy_ada.png")
plt.clf()
...
plt.legend(loc="best")
plt.savefig("learning_rate_vs_accuracy_ada.png")
plt.clf()
...
plt.legend(loc="best")
plt.savefig("iterations_vs_time_ada.png")
